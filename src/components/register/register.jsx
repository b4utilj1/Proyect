            ...
            <img src="https://cdn.discordapp.com/attachments/753054252020006953/1179955920466366558/LogoPNGG.png?ex=657baa95&is=65693595&hm=3e3c377ee2a83920d5951d3d4b7a76567f9e62c00eb76f3558bab25ed8fc5c97&" alt="" className='w-16/5 h-16/5'/>
                ...
                <div className='w-1/2 h-full bg-white flex flex-col p-20 justify-between items-center'>
                    ...
                    <div className='w-full flex flex-col max-w-[490px]'>
                        ...
                        <h3 className='text-3xl font-semibold mb-2'>Registrarse</h3>
                     </div> 
                    ...
                    <div className='w-full flex items-center justify-between '>
                        ...
                        <p className='text-sm font-medium whitespace-nowrap underline underline-offset-2  hover:text-red-600 cursor-pointer'>Ya tienes cuenta?</p>
                     </div>
                     <div className='w-full flex flex-col'>
                        <button className='w-full bg-blue-700 my-8 rounded-lg  justify-center text-white  p-3 text-center flex item-start'>Registrarse</button>
                     </div>
                        ...
                        <button>
                        <div className='w-full bg-blue-700 my-4 rounded-lg border-1  justify-center text-white  p-4 text-center flex item-start'>
                            <img  className='h-5 mr-2'src="https://cdn.discordapp.com/attachments/753054252020006953/1180991641033658418/siu.png?ex=657f6f2c&is=656cfa2c&hm=82ac1a9c207f9abf2cba5cd32fa882384ba7e6c5c6cf338d81c934fc68ed2a37&" alt="" />
                            Registrarse Con Facebook
                        </div>
                        </button>
                </div>
                <div className='w-full items-center justify-center'>
                    <p className='text-sm font-normal text-center text-black'>Ya tienes una cuenta?<span className='font-semibold text-blue-500 underline underline-offset-2 cursor-pointer '><a href="">Iniciar Sesión</a></span></p>
                </div>
            </div>
         </div>
        </>
